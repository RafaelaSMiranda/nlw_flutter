...
import 'package:nlw_flutter/modulos/login/login_controller.dart';
...
import 'package:nlw_flutter/shared/widgets/social_login.dart';
        ...
        child: Stack(
          children: [
            ...
            Positioned(
                ...
                left: 0,
                right: 0,
                child: Image.asset(AppImages.person, width: 300, height: 450)),
            Positioned(
